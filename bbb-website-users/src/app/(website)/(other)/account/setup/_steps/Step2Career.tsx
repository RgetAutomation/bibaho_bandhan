...
export const step2Schema = updateProfileSchema.pick({
  ...
  companyName: true,
  monthlyIncome: true, // Used as Annual Income based on previous map
  education: true,
...
export default function Step2Career({ onComplete, onBack }: { onComplete: () => void; onBack: () => void }) {
  ...
  const form = useForm<any>({
    ...
    defaultValues: {
      employmentType: stateData.employmentType || "",
      profession: stateData.profession || "",
      occupationDetails: stateData.occupationDetails || "",
      ...
      collegeInstitution: stateData.collegeInstitution || "",
      fieldOfStudy: stateData.fieldOfStudy || "",
    },
  });
