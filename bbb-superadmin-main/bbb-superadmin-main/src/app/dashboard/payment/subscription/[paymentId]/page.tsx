...
import { getSubscriptionPaymentDetailsByPaymentId } from "@/action/payment";
...
export default async function ViewPaymentDetails({
  ...
  const payment = await getSubscriptionPaymentDetailsByPaymentId(paymentId);
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 md:p-6">
      ...
      <div className="flex flex-col gap-6 py-6 lg:flex-row">
        <Card className="w-full max-w-md gap-4 rounded-2xl pt-0 shadow-lg transition hover:shadow-xl">
          {/* User Header */}
          ...
          <CardContent className="space-y-3 p-4">
            ...
            <div className="flex flex-col space-y-2 rounded-2xl border p-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">{payment.plan.title}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span>{payment.plan.duration} days</span>
              </div>
            </div>
