...
export default function BrideListClient({
  data,
  page,
  totalPages,
  total,
        ...
        <div className="flex w-full flex-col items-center gap-3 md:w-auto md:flex-row">
          ...
          <Select value={sortBy} onValueChange={setSortBy}>
            ...
            <SelectContent>
              ...
              <SelectItem value="direct-active">My Non-Block Brides</SelectItem>
      ...
      {data?.length === 0 ? (
        ...
        >
          <div className="grid w-full grid-cols-1 gap-4 space-y-4 md:grid-cols-2 lg:grid-cols-3">
            {data.map((bride) => (
              <Link href={`/dashboard/profile/user/${bride.id}`} key={bride.id}>
