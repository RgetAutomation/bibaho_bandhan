...
import { getAllGroomsConversations } from "@/actions/admin";
...
export default function GroomClientComponent({
  ...
  const {
    ...
    queryKey: ["getAllGroomsConversations"],
    queryFn: () => getAllGroomsConversations(),
  });
  ...
  }, [teamUserSocket, isConnected, queryClient, joinConversation, grooms]);
